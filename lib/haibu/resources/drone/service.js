...
exports.createRoutes = function createRoutes(router) {
   ...
   router.get("/drone/", function getDrones() {
      var res = this.res;
      Drone.all(function dronesRetrieved(err, drones) {
         if (err) res.json(500, err);
         else res.json(200, drones);
      });
   });
